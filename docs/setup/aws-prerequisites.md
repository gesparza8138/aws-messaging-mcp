...
Account: `585008049602` (Gabes-Dev-Account-2), region `us-west-2`. Domain: `gabriel-esparza.com` (GoDaddy), subdomain `mcp.gabriel-esparza.com` delegated to Route 53 per [`dns.md`](dns.md).
...
| `RecipientAllowList` (dev only) | `esparza.gabriel@gmail.com`, `+17605969705` | — | §5 |
...
| Phone | `+17605969705` | `sms_*` E2E, RCS test device |
